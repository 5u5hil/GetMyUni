                    ...
                    <?php foreach ($news as $get_news) { ?>
                        ...
                        <div class="row mb20">
                            ...
                            <div >
                                <div class="col-sm-9 col-md-9"> 
                                    <div class="row">
                                        <h3 class="tcol_darkblue mt0"><a href="<?php echo $get_news['link']; ?>" target="_blank"  style="display:inline;text-decoration:none" ><?php echo html_entity_decode($get_news['title'], ENT_QUOTES, "UTF-8"); ?></a> </h3>
                                        <div class="news_source"><?php echo $get_news['source']; ?>  <span> <?php echo $get_news['date_time']; ?></span></div>
                                        <div class="news_desc "> <?php echo html_entity_decode($get_news['desc'], ENT_QUOTES, "UTF-8"); ?></div>
