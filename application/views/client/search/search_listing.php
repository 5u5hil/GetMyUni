...
<html lang="en"><head>
  ...
  <body>
      ...
      <div class="container">
			<?php $this->load->view(CLEINT_HEADER);?>
                ...
                <div class="row mt30">
                  ...
                  <div class="accordion" id="leftMenu">
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#leftMenu" href="#collapseOne">
                                  Degree Typesdsf <i class="fa fa-caret-down pull-right"></i> 
                            </a>
                        </div>
                	...
                	<div class="col-sm-9 col-md-9 col-xs-12">
                       ...
                       <div class="row mt30">
                       	<div class="col-sm-3 col-md-3">
                        	<img src="<?php echo CLIENT_IMAGES ;?>default.png"  class="school_logo img-responsive"/>
                            <div class="btn btn-sm listing_follow">Follow this school</div>
                            <div class="compare_circle">+</div> <span class="tcol_darkblue f_18">Compare</span>
                        </div>
                       	<div class="col-sm-6 col-md-6">
                        	<h2 class="tcol_darkblue mt0">Harvard University</h2>
                            ...
                            <div class="row mt10">
                            	<div class="col-sm-6 col-md-6 border-right">
                                    ...
                                    <div class="col_det_value"> $35,000</div>
                                </div>
                            	<div class="col-sm-6 col-md-6 ">
                                	<div class="col_det_title"> Acceptance Rate</div>
                                    <div class="col_det_value"> 7%</div>
                                </div>
                            </div>
                          	<div class="row mt10">
                            	<div class="col-sm-6 col-md-6 border-right">
                                	<div class="col_det_title"> Test scores</div>
                                    <div class="col_det_value"> GMAT 700</div>
                                </div>
                            	<div class="col-sm-6 col-md-6 ">
                                	<div class="col_det_title"> Average Salary</div>
                                    <div class="col_det_value"> $70,000</div>
                                </div>
                            </div>
                        </div>
                       	<div class="col-sm-3 col-md-3">
        ...
        <footer>
            <?php $this->load->view(CLEINT_FOOTER);?>
        </footer>
    </div>
