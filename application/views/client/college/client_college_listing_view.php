                            ...
                            <div id="collapseOne" class="accordion-body collapse" style="height: 0px; ">
                                <div class="accordion-inner">
                                    <ul class="acc_submenu">
                                        <li><input type="radio" name="degree" class="degree" id="bachelors" value="bachelors" <?php
                                            if (@$_POST['degree'] == "bachelors") {
                                                echo "checked = true";
                                            }
                                            ?>> <label for="bachelors">Bachelors</label> </li>
                                        <li><input type="radio" name="degree" class="degree" id="masters" value="masters" <?php
                                            if (@$_POST['degree'] == "masters") {
                                                echo "checked = true";
                                            }
                                            ?>> <label for="masters">Masters</label></li>
                                        <li><input type="radio" name="degree" class="degree" id="doctorate" value="doctorate" <?php
                                            if (@$_POST['degree'] == "doctorate") {
                                                echo "checked = true";
                                            }
                                            ?>> <label for="doctorate">Doctorate</label></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
