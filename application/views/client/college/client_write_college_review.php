         ...
         <div class="row mt20 mb50">
            <!--form action="#" method="post" class="review_email_form"-->
              ...
              <div class="col-sm-4 col-md-4 ">
                <div class="form-group"><input type="text" placeholder="Email" class="form-control" name="email" id="email"></div>
              </div>
              ...
              <div class="col-sm-4 col-md-4 ">
                <div class="form-group"><input type="text" placeholder="Enter Passcode" class="form-control"></div>
              </div>
              <div class="col-sm-2 col-md-2 pull-right">
