...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                var myParams = {
                    'clientid': '594635791315-ccdbp2d9g34fbdt38heap2qnfkt9ndc9.apps.googleusercontent.com',
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-offset-4 col-md-4 col-sm-4 col-xs-12 text-center">
                    ...
                    <div class="btn btn-xlarge btn-google-plus signbtn" id="signinButton" onclick="glogin()"><i class="fa fa-2x fa-google-plus"></i>  Connect with Google +</div>
                            ...
                            <form id="login_user_form" onsubmit="return false">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12"><div class="hv_acct">Forgot Password?<span><a href="javascript:;" data-toggle="modal" data-target="#myModalFP" id="fpass"> Click Here</a></span></div></div>
                                    </div>
                                </div>
    ...
    <div class="col-sm-9"><div class="hv_acct">Already have an account? <span><a href="#" onclick="toggle_visibility('login_form_div');">Login</a></span></div></div>
        ...
        <div class="modal fade" id="myModalFP" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h2 class="tcol_darkblue mb20"> Enter the Registered Email Address </h2>
                    </div>
                    <form  method="post">
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="col-sm-12 emdiv">
                                    <input type="email" value="" id="em" name="em" data-helper="" class="form-control " data-progression="" placeholder="Email" required/>
                                    <span></span>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary femdsub">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
                                            ...
                                            $(document).ready(function() {
                                                $(".femdsub").click(function(e) {
                                                    e.preventDefault();
                                                    $.ajax({
                                                        url: "/client/client_login/forgot_pass_email_validation",
                                                        type: "post",
                                                        data: {email: $("#em").val()},
                                                        success: function(data) {
                                                            if (data == 1) {
                                                                $(".emdiv").html("Password Reset Link has been sent to you!")

                                                                $(".emdiv span").html("");
                                                                $(".femdsub").hide();
                                                            } else {
                                                                $(".emdiv span").html("Sorry! This Email is not registered with us!");
                                                            }
