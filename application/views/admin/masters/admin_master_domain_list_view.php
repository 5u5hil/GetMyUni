	...
	<!----------header------------->
		...
		<div class="contentpanel"><!-- Content Panel -->
			...
			<div class="row mb10"><!-- Exhibitor Row -->
				...
				<div class="col-sm-12 col-md-12">
					<a class="btn btn-primary btn-block" href="<?php echo ADMIN_SITE_URL?>college_master/master_domain_add_edit">Add Master Domain</a>
				</div>
		...
		<?php 
                    ...
                    if($get_master_domain != "no")
                    {
                        foreach($get_master_domain as $domain_name)
                        {
                        
                 ?>
						
                <tr class="odd gradeX" id="master-domain_<?php echo $domain_name['id']; ?>">
                       <td class="text-center"><!--input type="checkbox"--></td>
                       <td><?php echo $domain_name['domains_name'] ;?></td>
                       <td class="center">
                               <!--a href="#"><i class="fa fa-bar-chart-o"></i></a-->
                               <a href="<?php echo ADMIN_SITE_URL?>college_master/master_domain_add_edit/<?php echo $domain_name['id'];?>"><i class="fa fa-pencil"></i></a>
                               <a id="<?php echo $domain_name['id'];?>" class="delete_master_domain"><i class="fa fa-trash-o"></i></a>
                       </td>
                </tr>
                <?php 
                        }
